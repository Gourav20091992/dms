...
public class BookingController {
    ...
    public ResponseEntity<List<FinalBookingProjection>> getPrevious10Bookings(
        ...
        return new ResponseEntity<>(bookingService.getPrevious10Bookings(mblNo), HttpStatus.OK);
    }
}
